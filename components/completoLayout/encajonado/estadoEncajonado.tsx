      ...
      <div className="h-full w-full">
        <ul className="w-full h-full flex flex-col p-0 m-0 gap-2 text-[#d9d9d9] list-none">
          {estadoMaquina === "CICLO ACTIVO" ? (
            <li className="flex flex-col p-[0.4vw_0.8vw] rounded-[0.7vw] bg-[#581420] max-h-[65px] h-full w-full transition-colors duration-800 shadow-[6px_6px_6px_0px_rgba(0,0,0,0.45)]">
